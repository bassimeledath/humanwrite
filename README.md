...
4. `infra/gpu`, the constrained Modal gateway, separate reaper, checkpoint
   ...
   implemented with internal $100 monthly GPU and API caps.
...
2. Set provider-side hard caps of $100 in Modal and OpenRouter, with automatic
   top-ups disabled where applicable.
